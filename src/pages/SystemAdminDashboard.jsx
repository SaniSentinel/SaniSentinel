          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-6 text-sm">
              <div className="text-center">
                <div className="font-semibold" style={{ color: unicefColors.primary }}>{stats.facilities?.total || 0}</div>
                <div className="text-gray-600">Active Facilities</div>
              </div>
              <div className="text-center">
                <div className="font-semibold" style={{ color: unicefColors.success }}>{stats.districts?.total || 0}</div>
                <div className="text-gray-600">Districts</div>
              </div>
              <div className="text-center">
                <div className="font-semibold" style={{ color: unicefColors.warning }}>{alertSummary?.total || 0}</div>
