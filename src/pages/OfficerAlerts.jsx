            ...
            return (
              <div
                ...
                className={`bg-white border rounded-xl p-5 shadow-sm ${
                  isNew ? 'ring-2 ring-green-400 ring-offset-2' : 'border-gray-200'
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`h-2 w-2 rounded-full ${dot}`} title={alert.severity} />
                        <span className="text-xs uppercase text-gray-500">{alert.severity}</span>
                      </div>
